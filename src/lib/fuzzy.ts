/** Sequential fuzzy match — all query characters in order, with bonuses for
 *  consecutive runs, path separators, and camelCase boundaries.
 *  Ported from reference/R1/src/lib/fuzzy.ts. */
